...
public class GetTopicByEmotionWithTimeServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String kind = "topic_by_emotion＿with_time";
		String name = "topic";
	...
	private String writeJSON(Iterable<Entity> entities) {
		...
		Column time = new Column.Builder(Column.TYPE_DATE)
		.setId("time")
		.setLabel("日期")
		.build();
		...
		for (Entity result : entities) {
			...
			Cell timeCell = new Cell(String.valueOf(properties.get("time")), null, null);
